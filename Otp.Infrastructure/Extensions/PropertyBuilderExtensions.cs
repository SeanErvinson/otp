...
public static class PropertyBuilderExtensions
{
	...
	{
		var valueConverter = new ValueConverter<T, string>(c => JsonSerializer.Serialize(c, new JsonSerializerOptions
		{
		...
		var valueComparer = new ValueComparer<T>(
			...
			v => JsonSerializer.Deserialize<T>(JsonSerializer.Serialize(v, new JsonSerializerOptions()), new JsonSerializerOptions()) ?? new T());
