...
public sealed record UpdateBrandingRequest(IFormFile? BackgroundImage,
	IFormFile? LogoImage,
	string? SmsMessageTemplate);

public sealed record UpdateBranding : IRequest<AppResponse>
{
...
public class UpdateBrandingHandler : IRequestHandler<UpdateBranding, AppResponse>
{
	...
	public UpdateBrandingHandler(IBlobStorageService blobStorageService,
