...
public sealed record GetOtp(Guid Id) : IRequest<GetOtpResponse>;

public class GetOtpHandler : IRequestHandler<GetOtp, GetOtpResponse>
{
	private readonly IApplicationDbContext _dbContext;
	private readonly ICurrentUserService _currentUserService;
	
	public GetOtpHandler(IApplicationDbContext dbContext, ICurrentUserService currentUserService)
	{
...
public sealed record GetOtpResponse
{
...
public sealed record OtpEventResponse
{
...
public sealed record OtpAttemptResponse
{
